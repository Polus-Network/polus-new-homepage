<template>
  ...
  <div class="input-container">
    <div   class="video-section max-w-7xl mx-auto mt-1">
    <div class="video-container" ref="videoContainer" @click="playVideo">
      <video autoplay ref="videoElement" :src="videoSource" class="video rounded-3xl"></video>
    </div>
  </div>
  </div>
</form>
...
import videoSource from '../assets/videobyfiver.mp4';
